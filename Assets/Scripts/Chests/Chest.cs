...
public class Chest : MonoBehaviour, IUseable
{
    ...
    private WeaponDetailsScriptableObject weaponDetails;
    ...
    public void Initialize(bool shouldMaterialize, int healthPercent, WeaponDetailsScriptableObject weaponDetails, int ammoPercent)
    {
