...
public class ChestSpawner : MonoBehaviour
{
    ...
    #endregion Tooltip
    [SerializeField] private List<SpawnableObjectsByLevel<WeaponDetailsScriptableObject>> weaponSpawnByLevelList;
    ...
    private WeaponDetailsScriptableObject GetWeaponDetailsToSpawn(int weaponNumber)
    {
    ...
    private void OnValidate()
    {
        ...
        {
            foreach (SpawnableObjectsByLevel<WeaponDetailsScriptableObject> weaponDetailsByLevel in weaponSpawnByLevelList)
            {
                HelperUtilities.ValidateCheckNullValue(this, nameof(weaponDetailsByLevel.dungeonLevel), weaponDetailsByLevel.dungeonLevel);
                foreach (SpawnableObjectRatio<WeaponDetailsScriptableObject> weaponRatio in weaponDetailsByLevel.spawnableObjectRatioList)
                {
