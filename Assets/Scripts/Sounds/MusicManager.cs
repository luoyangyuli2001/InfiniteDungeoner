...
public class MusicManager : SingletonMonobehaviour<MusicManager>
{
    ...
    private IEnumerator PlayMusicRoutine(MusicTrackScriptableObject musicTrack, float fadeOutTime, float fadeInTime)
    {
    ...
    private IEnumerator FadeInMusic(MusicTrackScriptableObject musicTrack, float fadeInTime)
    {
