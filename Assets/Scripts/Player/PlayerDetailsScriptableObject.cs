...
public class PlayerDetailsScriptableObject : ScriptableObject
{
    ...
    #endregion
    public WeaponDetailsScriptableObject startingWeapon;
    #region Tooltip
    [Tooltip("Populate with the list of starting weapons")]
    #endregion
    public List<WeaponDetailsScriptableObject> startingWeaponList;
