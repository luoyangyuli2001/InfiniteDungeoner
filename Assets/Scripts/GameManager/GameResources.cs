...
public class GameResources : MonoBehaviour
{
    ...
    #endregion
    #region Tooltip
    [Tooltip("Populate with the dungeon RoomNodeTypeListScriptableObject")]
    #endregion

    public RoomNodeTypeListScriptableObject roomNodeTypeList;
    ...
    #endregion Tooltip
    public List<PlayerDetailsScriptableObject> playerDetailsList;
    #region Tooltip
    ...
    #endregion
    public SoundEffectScriptableObject doorOpenCloseSoundEffect;
    #region Tooltip
    [Tooltip("Populate with the table flip sound effect")]
    #endregion
    public SoundEffectScriptableObject tableFlip;
    #region Tooltip
    [Tooltip("Populate with the chest open sound effect")]
    #endregion
    public SoundEffectScriptableObject chestOpen;
    #region Tooltip
    [Tooltip("Populate with the health pickup sound effect")]
    #endregion
    public SoundEffectScriptableObject healthPickup;
    #region Tooltip
    [Tooltip("Populate with the weapon pickup sound effect")]
    #endregion
    public SoundEffectScriptableObject weaponPickup;
    #region Tooltip
    ...
    #endregion Tooltip
    public MusicTrackScriptableObject mainMenuMusic;
