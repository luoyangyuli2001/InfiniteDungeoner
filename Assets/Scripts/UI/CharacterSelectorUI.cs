...
public class CharacterSelectorUI : MonoBehaviour
{
    ...
    private List<PlayerDetailsScriptableObject> playerDetailsList;
    private GameObject playerSelectionPrefab;
    private CurrentPlayerScriptableObject currentPlayer;
    ...
    private void PopulatePlayerDetails(PlayerSelectionUI playerSelection, PlayerDetailsScriptableObject playerDetails)
    {
